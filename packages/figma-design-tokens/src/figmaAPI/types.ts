 ...
 */
export interface IContainingStateGroup {
...
export interface IDocumentationLinks {
...
export interface IComponent {
  ...
  documentationLinks: IDocumentationLinks[];
}
...
export type STAR = IVECTOR;

/** A straight line */
export type LINE = IVECTOR;

/** An ellipse */
export type ELLIPSE = IVECTOR;

/** A regular n-sided polygon */
export type REGULAR_POLYGON = IVECTOR;

/** A rectangle */
export type RECTANGLE = IVECTOR & {
...
export type COMPONENT = IFRAME;

/** A node that can have instances created of it that share the same properties */
export type COMPONENT_SET = IFRAME;

/** An instance of a component, changes to the component result in the same changes applied to the instance */
export type INSTANCE<ComponentID = string> = IFRAME & {
...
export type FigmaNode<NType extends NodeType = NodeType> = {
  id: string;
  name: string;
  visible: boolean;
  type: NType;
...
export function isNodeType<NType extends NodeType, R = FigmaNode<NType>>(
  node: FigmaNode<any>,
  type: NType
): node is R {
...
/** A group that has a boolean operation applied to it */
export type BOOLEAN = IVECTOR & {
  /** An array of nodes that are being boolean operated on */
  children: FigmaNode[];
};

/** A group that has a boolean operation applied to it */
export type BOOLEAN_OPERATION = IVECTOR & {
  /** An array of nodes that are being boolean operated on */
  children: FigmaNode[];
...
export type FigmaNodeWithChildren =
  | IDOCUMENT
  | BOOLEAN_OPERATION
  | BOOLEAN
  | ICANVAS
...
export function isNodeTypeWithChildren(
  node: FigmaNode<any>
): node is FigmaNodeWithChildren {
